...
// this function returns the markup for a planet div
const Planet = (props) => {
  return (
    <div className="card">
      <div>
  ...
  return (
    <div className="container"> 
        {props.planets.map(planet => 
          <Planet 
            {...planet} // the spread operator eliminates the need to write all of the below
            // name={planet.name}
...
ReactDOM.render(
  // PlanetList is the component we're going to render
  // pass the planets array
